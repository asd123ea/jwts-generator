...
./gen-jwt.py key.pem -listclaim key1 val2 val3 -listclaim key2 val3 val4
./gen-jwt.py key.pem -listclaim key1 val2 val3 -listclaim key2 val3 val4 -listclaim groups group1 group11234 --expire 5
"""
